...
const MACHINE_TYPE_COMPRESSORS = 6;
const MACHINE_TYPE_OTHER = 7;

const MACHINE_TYPES = array(MACHINE_TYPE_PRINTERS, MACHINE_TYPE_LAMINATORS, MACHINE_TYPE_CUTS, MACHINE_TYPE_CARS, MACHINE_TYPE_LOADERS, MACHINE_TYPE_COMPRESSORS, MACHINE_TYPE_OTHER);
const MACHINE_TYPE_NAMES = array(MACHINE_TYPE_PRINTERS => "Печатные машины", MACHINE_TYPE_LAMINATORS => "Ламинаторы", MACHINE_TYPE_CUTS => "Резки", MACHINE_TYPE_CARS => "Автомобили", MACHINE_TYPE_LOADERS => "Погрузчики", MACHINE_TYPE_COMPRESSORS => "Компрессоры", MACHINE_TYPE_OTHER => "Другое");
